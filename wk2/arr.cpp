...
// Arrays, Loops, Enums, and Switch Statements
...
int main() {
    ...
    scores[3] = 2456;
    scores[4] = -4;
    // scores[5] = 99999;    // cant go past the size of the array
    ...
    // enum numerator is a custom variable type
    // with only values that we specify
